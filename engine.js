    ...
    "accarezzare": {type:"are", stem:"accarezz", aux:"avere", pp:"accarezzato"},            "abbracciare": {type:"iare", stem:"abbracc", aux:"avere", pp:"abbracciato"},
...
"allontanare":{type:"are", stem:"allontan", aux:"avere", pp:"allontanato"},
            ...
            "arrabbiarsi":{type:"iare-rfl", stem:"arrabb", aux:"essere", pp:"arrabbiato"},
"arrabbiare": {type:"iare", stem:"arrabb", aux:"avere", pp:"arrabbiato"},
            ...
            "assaggiare": {type:"iare", stem:"assagg", aux:"avere", pp:"assaggiato"},
            ...
            "avere":      {type:"irr"},
            "avvenire":    {type:"irr"},
            "abbracciarsi":{type:"iare-rfl", stem:"abbracc", aux:"essere", pp:"abbracciato"},
    ...
    "baciare": {type:"iare", stem:"bac", aux:"avere", pp:"baciato"},            "bagnarsi":   {type:"are-rfl", stem:"bagn", aux:"essere", pp:"bagnato"},
            ...
            // C 补充
            "cambiare":   {type:"iare", stem:"camb", aux:"avere", pp:"cambiato"},
    ...
    "diventare": {type:"are", stem:"divent", aux:"essere", pp:"diventato"},
...
"divertire":  {type:"ire", stem:"divert", aux:"avere", pp:"divertito"},
    ...
    "fiutare":     {type:"are", stem:"fiut", aux:"avere", pp:"fiutato"},            "fare":       {type:"irr"},
            ...
            "festeggiare": {type:"iare", stem:"festegg", aux:"avere", pp:"festeggiato"},
            ...
            // G
            "galleggiare":   {type:"iare", stem:"gallegg", aux:"avere", pp:"galleggiato"},
...
"iscrivere":  {type:"ere", stem:"iscriv", aux:"avere", pp:"iscritto", pres:["iscrivo","iscrivi","iscrive","iscriviamo","iscrivete","iscrivono"], rem:["iscrissi","iscrivesti","iscrisse","iscrivemmo","iscriveste","iscrissero"]},
            ...
            "ingoiare":     {type:"iare", stem:"ingo", aux:"avere", pp:"ingoiato"},
            ...
            "iniziare":   {type:"iare", stem:"iniz", aux:"avere", pp:"iniziato"},
            ...
            "lanciare":      {type:"iare", stem:"lanc", aux:"avere", pp:"lanciato"},
            "lasciare":   {type:"iare", stem:"lasc", aux:"avere", pp:"lasciato"},
            ...
            "mangiare":   {type:"iare", stem:"mang", aux:"avere", pp:"mangiato"},
            "mangiarsi":   {type:"irr"},
            "mantenere":   {type:"irr"},
...
"mettere":    {type:"ere", stem:"mett", aux:"avere", pp:"messo", rem:["misi","mettesti","mise","mettemmo","metteste","misero"]},
            ...
            "odiare":       {type:"iare", stem:"od", aux:"avere", pp:"odiato"},
...
"preparare":  {type:"are", stem:"prepar", aux:"avere", pp:"preparato"},
            ...
            "passeggiare":    {type:"iare", stem:"passegg", aux:"avere", pp:"passeggiato"},
            ...
            "produrre":       {type:"irr"},
            "pronunciare":    {type:"iare", stem:"pronunc", aux:"avere", pp:"pronunciato"},
            "proporre":       {type:"irr"},
    ...
    "riuscire": {type:"irr", stem:"", aux:"essere", pp:""},            "regalare":   {type:"are", stem:"regal", aux:"avere", pp:"regalato"},
            ...
            "rimanere":   {type:"irr"},
            "rimangiare":  {type:"iare", stem:"rimang", aux:"avere", pp:"rimangiato"},
            "rimangiarsi": {type:"irr"},
            "ringraziare":{type:"iare", stem:"ringraz", aux:"avere", pp:"ringraziato"},
    ...
    "sfuggire":    {type:"ire", stem:"sfugg", aux:"avere", pp:"sfuggito"},            "salire":      {type:"irr"},
            ...
            "sapere":     {type:"irr"},
            "sbagliare":  {type:"iare", stem:"sbagl", aux:"avere", pp:"sbagliato"},
            ...
            "sorvegliare": {type:"iare", stem:"sorvegl", aux:"avere", pp:"sorvegliato"},
            ...
            "stare":      {type:"irr"},
            "studiare":   {type:"iare", stem:"stud", aux:"avere", pp:"studiato"},
            ...
            "svegliarsi": {type:"iare-rfl", stem:"svegl", aux:"essere", pp:"svegliato"},
            "svegliare":  {type:"iare", stem:"svegl", aux:"avere", pp:"svegliato"},
            // S 补充
...
"trasferire": {type:"ire-isc", stem:"trasfer", aux:"avere", pp:"trasferito"},
            ...
            // T 补充
            "tagliare":   {type:"iare", stem:"tagl", aux:"avere", pp:"tagliato"},
            "tenere":     {type:"irr"},
            ...
            "testimoniare":{type:"iare", stem:"testimon", aux:"avere", pp:"testimoniato"},
            ...
            "umiliare":   {type:"iare", stem:"umil", aux:"avere", pp:"umiliato"},
            ...
            "viaggiare":  {type:"iare", stem:"viagg", aux:"avere", pp:"viaggiato"},
            ...
            "variare":    {type:"iare", stem:"var", aux:"avere", pp:"variato"},
            "vendicarsi": {type:"irr"},
"vendicare":  {type:"care", stem:"vendic", aux:"avere", pp:"vendicato"},
    ...
    "zittirsi":    {type:"irr"},            "zittire":     {type:"ire-isc", stem:"zitt", aux:"avere", pp:"zittito"},
        ...
        function conjVerbs(infinito, m) {
            const s = m.stem;
            const isRfl = m.type === "are-rfl" || m.type === "ere-rfl" || m.type === "ire-rfl" || m.type === "iare-rfl";
